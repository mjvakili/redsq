...
def mcmc(zmin , zmax , iteration):     
    ...
    fig_file = "/home/vakili/public_html/files/redsequence_temp/"+str(zmin)+"_z_"+str(zmax)+"burn_iter"+str(iteration)+".png"
    ...
    axes[-1].set_xlabel("Step Number", fontsize=25)
    fig.tight_layout(h_pad=0.0)
    fig_file = "/home/vakili/public_html/files/redsequence_temp/"+str(zmin)+"_z_"+str(zmax)+"chain_iter"+str(iteration)+".png"
    plt.savefig(fig_file)
    plt.close()
    ...
    #fig.tight_layout()
    fig_file = "/home/vakili/public_html/files/redsequence_temp/"+str(zmin)+"_z_"+str(zmax)+"color_iter"+str(iteration)+".png"
    plt.savefig(fig_file)
    plt.close()
...
def mcmc_fg(zmin , zmax , iteration):     
    ...
    axes[-1].set_xlabel("Step Number", fontsize=25)
    fig.tight_layout(h_pad=0.0)
    fig_file = "/home/vakili/public_html/files/redsequence_temp/"+str(zmin)+"_z_"+str(zmax)+"fg_burn_iter"+str(iteration)+".png"
    plt.savefig(fig_file)
    plt.close()
    ...
    axes[-1].set_xlabel("Step Number", fontsize=25)
    fig.tight_layout(h_pad=0.0)
    fig_file = "/home/vakili/public_html/files/redsequence_temp/"+str(zmin)+"_z_"+str(zmax)+"fg_chain_iter"+str(iteration)+".png"
    plt.savefig(fig_file)
    plt.close()
    ...
    fig_file = "/home/vakili/public_html/files/redsequence_temp/"+str(zmin)+"_z_"+str(zmax)+"fg_color_iter"+str(iteration)+".png"
    plt.savefig(fig_file)
    plt.close()
